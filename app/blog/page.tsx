...
export default async function PostsPage() {
	...
	const featured = allPosts.find((post) => post.slug === "test1")!;
	const top2 = allPosts.find((post) => post.slug === "test12")!;
	const top3 = allPosts.find((post) => post.slug === "test123")!;
			...
			<div className="px-6 pt-24 mx-auto space-y-8 max-w-7xl lg:px-8 md:space-y-16 md:pt-24 lg:pt-32">
				<div className="max-w-2xl mx-auto lg:mx-0">
					...
					<p className="mt-4 text-zinc-400">
						Here you can find some of my blog posts, mostly about technology but some random stuff too.
					</p>
				</div>
